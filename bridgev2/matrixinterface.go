...
type MatrixAPI interface {
	...
	UploadMediaStream(ctx context.Context, roomID id.RoomID, size int64, requireFile bool, fileName, mimeType string, cb func(file io.Writer) error) (url id.ContentURIString, file *event.EncryptedFileInfo, err error)
