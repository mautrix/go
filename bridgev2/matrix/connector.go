	...
	for {
		...
		if err != nil {
			...
			*br.AS.SpecVersions = *versions
			...
			br.Capabilities.ReplaceEntireProfile = br.SpecVersions.Supports(mautrix.FeatureUnstableReplaceProfile) ||
				br.SpecVersions.Supports(mautrix.FeatureStableReplaceProfile)
