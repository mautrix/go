...
type OlmMachine struct {
	...
	// Optional callback which is called for MSC4385 secret pushes from cross-signed devices of
	// our own user. It is responsible for validating and storing the secret; pushes are dropped when it's unset.
