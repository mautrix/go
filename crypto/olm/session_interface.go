...
type Session interface {
	...
	// Decrypt decrypts a message using the Session. Returns the the plain-text
	// on success. Returns error on failure. If the base64 couldn't be decoded
